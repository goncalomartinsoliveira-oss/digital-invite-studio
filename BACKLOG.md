...
- [ ] Portal do fornecedor (link de leitura, sem conta DIS) — a discutir à parte antes de construir: é a primeira superfície do módulo aberta a alguém fora da plataforma, com implicações de segurança diferentes do resto
