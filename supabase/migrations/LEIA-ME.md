...
| `0006_moodboard.sql` | `event_moodboard_items` — moodboard do evento (imagens carregadas ou links com miniatura extraída), sempre partilhado entre agência e casal, sem distinção agency/shared | ☐ |
