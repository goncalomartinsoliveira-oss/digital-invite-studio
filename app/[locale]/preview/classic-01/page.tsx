...
const DEMO_DATA = {
  ...
  content: {
    ...
    content: {
      hero: {
        text_above_names: "Convidam-vos para celebrar",
...
export default async function PreviewClassic01(props: { params: Promise<{ locale: string }> }) {
    ...
    <>
      <div className="fixed top-0 left-0 right-0 z-[999] bg-[#2D4A3E] text-white flex items-center justify-between px-5 py-3 shadow-lg font-montserrat">
        <div className="flex items-center gap-3">
          ...
          <span className="text-[10px] font-semibold uppercase tracking-widest text-white/70">Template — Clássico</span>
        </div>
        <div className="flex items-center gap-3">
